...
Organize GUI controls using columns, folders, tabs, and nested structures for better user experience.

**Features:**

* Responsive columns with ratio-based widths (`add_columns`) that collapse into a tabbed view on small screens
